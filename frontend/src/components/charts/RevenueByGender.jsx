...
export default function RevenueByGender({ data }) {
  const chartData = Array.isArray(data) && data.length ? data : [
    { name: 'Female', revenue: 75191 },
    { name: 'Male', revenue: 157890 },
  ]
  ...
  return (
    <div style={{
      ...
      <h3 style={{ fontSize: '1.125rem', fontWeight: '600', color: '#F8FAFC', marginBottom: '1.5rem' }}>Revenue by Gender</h3>
